...
export default function AboutUs() {
  ...
  <div className="leftSection w-full md:h-full bg-cover bg-center" id="About">
  ...
  >
    ...
    <button className="bg-[#eec04b] hover:bg-blue-700 font-bold lg:py-3 lg:px-12 sm:py-2 sm:px-6 md:absolute md:bottom-5 left-[50%] md:transform-[translateX(-50%)] md:z-20 rounded-3xl text-[#515151] ">
      Help Me
    </button>
  </div>
</section>
