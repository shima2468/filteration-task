...
export default function Hero() {
  return (
    <>
      <section className="bg-white  h-screen relative flex justify-center items-center ">
        ...
        <div className="z-20 flex  gap-16 flex-col justify-center items-center  absolute">
          ...
          <div className="hero-content text-white text-center ">
            ...
            <h2 className="my-2 text-4xl text-[#4F4F4F] md:text-5xl lg:text-6xl xl:text-7xl  text-center">
              <span className="font-extralight tracking-tight">Lorem</span>
              <span className="rounded-full text-black font-extrabold  block">
                Lorem lorem
              </span>{" "}
            </h2>
            <p className="my-3 w-1/2  min-w-50 md:max-w-4/9 mx-auto sm:my-4 sm:text-lg lg:text-sm text-black text-center">
