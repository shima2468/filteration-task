...
export default function Services() {
  return (
    <>
      <section
        className="relative flex flex-col justify-center items-center py-12"
        id="Serices"
      >
        ...
        <a
          href="#"
          className="inline-flex justify-center items-center mb-7 py-4 px-12 mt-6 bg-[#6D91EE] rounded-full hover:bg-gray-200"
        >
