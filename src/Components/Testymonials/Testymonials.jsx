...
export default function Testymonials() {
  return (
    <>
  <section className="relative flex flex-col justify-center items-center py-12 bg-[#f5f5f5]" id="Testymonials">
  ...
  <div className="flex flex-wrap justify-center gap-8 w-[90%]">
    <div className="bg-white rounded-3xl p-4 shadow-xl flex flex-col sm:flex-row w-full sm:w-[80%] md:w-[43%] xl:w-[35%] border-2 border-[#6D91EE] gap-4 items-center">
      <img className="rounded-full w-16 h-16 object-cover" src={test} alt="testimonial" />
      <div>
        <h5 className="mb-2 text-lg font-bold tracking-tight">Courtney Henry</h5>
